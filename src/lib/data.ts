import { Order, OrderLine, ChangeHistoryItem, Warehouse, Supplier, Reception, Material, MaterialReception, ConsultaRecord, AppVersion, WarrantyHistoryInfo, WarrantyPreviousOrder, Vehiculo, TipoRevision, Plantilla, PlantillaWithMaterials, PlantillaHistorial } from "@/types";
