 ...
 */
export const hasRole = async (role: 'ADMINISTRADOR' | 'EDICION' | 'CONSULTAS'): Promise<boolean> => {
  try {
 ...
 * @returns Promise with the result of the operation
 */
export const updatePassword = async (password: string): Promise<{ success: boolean; error?: Error }> => {
  try {
