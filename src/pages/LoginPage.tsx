...
>>>>>>> 2f8e6c92a0389e40286031fe3a956f6580559314
                    <button
                      type="button"
                      onClick={toggleResetMode}
                      className="text-sm text-[#91268F] hover:underline"
...
=======
        ...
        {/* Imagen del lado derecho - Sin bordes ni marcos */}
        <div className="w-96 h-96 flex items-center justify-center">
          {!imageError ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-[#91268F] to-[#7A1F79] flex items-center justify-center">
